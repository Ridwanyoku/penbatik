<x-app-layout>
    <div class="p-8 bg-white min-h-screen">
        <div class="max-w-xl mx-auto mb-10">
            ...
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Edit Staff Member</h1>
            <p class="text-[10px] text-gray-400 mt-1 uppercase tracking-[0.2em] font-medium">Update account credentials and profile</p>
        </div>
        ...
        <div class="max-w-xl mx-auto bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
            <form action="{{ route('staffs.update', $staff->id) }}" method="POST" class="space-y-6">
                ...
                <div class="pt-4 border-t border-gray-50">
                    <p class="text-[9px] text-gray-400 font-bold uppercase tracking-[0.2em] mb-4">Security (Leave blank to keep current password)</p>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mb-2 ml-1">New Password</label>
                ...
                <div class="pt-4">
                    <button type="submit" 
                        class="w-full bg-black text-white py-4 rounded-xl text-[10px] font-bold uppercase tracking-[0.3em] hover:bg-gray-800 transition-all shadow-md active:scale-[0.98]">
